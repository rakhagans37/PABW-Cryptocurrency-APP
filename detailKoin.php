...
<body class="bg-background w-screen font-sans">
    ...
    <div class=" w-full pt-[85px] px-[85px] flex flex-col gap-14">
        ...
        <div class="flex flex-row justify-between items-center">
            ...
            <button type="button" class="h-full text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
        ...
        <div class="w-full rounded-lg shadow bg-secondaryBg border-gray-700 mb-20">
            ...
            <div id="defaultTabContent">
                ...
                <div class="hidden p-4 rounded-lg md:p-8 bg-secondaryBg" id="statistics" role="tabpanel" aria-labelledby="statistics-tab">
                    <h2 class="mb-5 text-2xl font-extrabold tracking-tight text-white" id="forum">Forum Resmi : </h2>
...
<script type="module">
    ...
    // if (false) {
    //     document.getElementById("watchlist-button").className = "border focus:ring-4 focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 border-barColor text-barColor hover:text-white focus:barColor hover:bg-barColor";
    // } else {
    //     document.getElementById("watchlist-button").className = "border bg-barColor focus:ring-4 focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 border-barColor text-barColor hover:text-white focus:bg-transparent hover:bg-transparent";
    // }
    ...
    getMetaData({
        ...
        document.getElementById('forum').innerHTML = "Forum Resmi : " + '<a href="' + data.data[id].urls.message_board + '">' + data.data[id].urls.message_board + '</a>';
